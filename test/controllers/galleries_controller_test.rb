...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference("Gallery.count") do
      post galleries_url, params: { gallery: { description: @gallery.description, photo: @gallery.photo, title: @gallery.title, user_id: @gallery.user_id, when_went: @gallery.when_went } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { description: @gallery.description, photo: @gallery.photo, title: @gallery.title, user_id: @gallery.user_id, when_went: @gallery.when_went } }
